...
// hover(): 마우스를 올리고/뗐을 때 -> mouseover + mouseout 합친 형태
// $('.div-hover').hover(
//   function () {
//     $(this).addClass('hover');
//   },
...
$('#todo-form').on('submit', function (e) {
  ...
  e.preventDefault(); // 이벤트 기본 동작을 막는 메서드
  // -> 지금 이벤트가 submit 이기 때문에 default 값인 "새로고침"을 막음
