...
/*
authors, books, orders2 이름을 갖는 3개의 테이블을 생성합니다. 
...
orders2 테이블의 book_id 컬럼은 books 테이블의 book_id와 관계를 맺는다. 
...
-- < 실습 >
-- 직전 실습에서 생성한 authors, books, orders2 테이블에 데이터를 추가하는 INSERT 문을 실행하고 각 번호에 맞는 SQL문을 작성해주세요.
