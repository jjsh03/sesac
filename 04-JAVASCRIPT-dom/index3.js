...
div1.innerHTML = '여기는 <b>첫 번째</b> 태그!';
console.log(div1);
// div1.innerText = '여기는 <b>첫 번째</b> 태그!';
// console.log(div1);
// div1.textContent = '여기는 <b>첫 번째</b> 태그!';
// console.log(div1);

// 속성(attribute) 변경 -> 속성 값을 "설정"
const naver = document.getElementById('naver');
naver.setAttribute('href', 'https://www.google.com');

const pooh = document.getElementById('pooh');
pooh.setAttribute('src', './img/hangyodong.jpg');

// 속성값 가져오기
// getAttribute(속성명) -> 송석 값을 "얻기"
